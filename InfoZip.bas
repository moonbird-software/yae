...
Public Const INFOZIP_EXTRACT_ONLY_NEWER = 1
Public Const INFOZIP_CONVERT_SPACE_UNDERSCORE = 1
Public Const INFOZIP_OVERWRITE_PROMPT = 1
Public Const INFOZIP_VERBOSE = 0
Public Const INFOZIP_FEW = 1
Public Const INFOZIP_QUIET = 2
Public Const INFOZIP_WRITE_STDOUT = 1
Public Const INFOZIP_VERBOSE_LISTING = 1
Public Const INFOZIP_UPDATE = 1
Public Const INFOZIP_OVERWRITE = 1
Public Const INFOZIP_EOL_TRANSLATION = 1
Public Const INFOZIP_GET_ZIPINFO = 1
Public Const INFOZIP_CASE_SENSITIVE = 0
Public Const INFOZIP_CASE_INSENSITIVE = 1
Public Const INFOZIP_RESTORE_ACL = 1
Public Const INFOZIP_USE_PRIVILEGES = 2

Public Const INFOZIP_GREP_CASE_INSENSITIVE = 0
Public Const INFOZIP_GREP_CASE_SENSITIVE = 1
Public Const INFOZIP_GREP_CASE_INSENSITIVE_WHOLE_WORD = 2
Public Const INFOZIP_GREP_CASE_SENSITIVE_WHOLE_WORD = 3
Public Const INFOZIP_GREP_ERROR = -1
Public Const INFOZIP_GREP_NOMATCH = 0
Public Const INFOZIP_GREP_MATCH = 1
...
Sub Unzip(FileName As String, ExtractTo As String)
Dim x As Integer
'    vbzipinf = ""
    ...
    MYDCL.SpaceToUnderscore = 0
    MYDCL.PromptToOverwrite = 0
    MYDCL.fQuiet = 2
    MYDCL.ncflag = 0
    MYDCL.ntflag = 0
    MYDCL.nvflag = 0
    ...
    x = windll_unzip(0, vbzipnam, 0, vbxnames, MYDCL, MYUSER)
End Sub
' Main subroutine
